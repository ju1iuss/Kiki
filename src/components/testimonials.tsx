            ...
            <div className="py-16 md:py-32">
                <div className="mx-auto max-w-6xl px-6">
                    <div className="text-center">
                        <h2 className="text-3xl font-semibold">Join Founders Hitting Millions of Views</h2>
                        <p className="mt-6">Real founders using automated accounts to scale their reach.</p>
                    </div>
