    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-background/20 max-w-4xl border border-gray-200/30 dark:border-gray-800/30 backdrop-blur-[2px] lg:px-5')}>
