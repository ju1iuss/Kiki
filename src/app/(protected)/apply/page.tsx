...
export default function ApplyPage() {
    ...
    const handleNext = async () => {
        ...
        if (step === 3) {
            ...
            // COMMENTED OUT - No waitlist functionality
            // try {
    ...
    const handleSubmit = async () => {
        // COMMENTED OUT - Buying flow disabled
    ...
    // COMMENTED OUT - Payment flow disabled
    useEffect(() => {
        if (step === 4) {
            ...
            // Then show payment section after 4 seconds total - DISABLED
                            ...
                            <div className="space-y-4">
                                <div className={`text-center space-y-4 max-w-md mx-auto transition-opacity duration-1000 ${showCapacityMessage ? 'opacity-100' : 'opacity-0'}`}>
                                    <h2 className="text-xl font-semibold">
                                        {t('apply.capacity.title')} {t('apply.capacity.count') && <span className="text-[#ED5A0B] font-bold text-2xl">{t('apply.capacity.count')}</span>}
                                    </h2>
                                ...
                                {/* Payment Section - COMMENTED OUT - Buying flow disabled */}
                                {/* {showPayment && (
