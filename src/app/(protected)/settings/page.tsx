        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              <span className="text-sm sm:text-base text-gray-400 sm:w-24 font-medium">First Name</span>
              <input
                type="text"
                value={firstName}
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              <span className="text-sm sm:text-base text-gray-400 sm:w-24 font-medium">Last Name</span>
              <input
                type="text"
                value={lastName}
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              <span className="text-sm sm:text-base text-gray-400 sm:w-24 font-medium">Email</span>
