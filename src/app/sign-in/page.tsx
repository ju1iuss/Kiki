...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      ...
      <Link 
        href="/" 
        className="fixed top-4 left-4 p-2 rounded-lg hover:bg-gray-800/50 transition-colors z-10"
      >
      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        {/* Welcome Text */}
        <h1 className="text-3xl font-bold mb-12 font-marlinsoft text-white text-center">
          Welcome to Tasy
        </h1>
          ...
          {!showEmailForm ? (
            <>
              <Button
                type="button"
                size="lg"
                className="w-full bg-white text-black hover:bg-gray-100 border-0 font-marlinsoft text-base"
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              ...
              <Button type="submit" size="lg" className="w-full bg-white text-black hover:bg-gray-100 border-0 font-marlinsoft text-base" disabled={loading}>
        ...
        {/* Disclaimer */}
        <p className="mt-12 text-center text-xs text-gray-400 max-w-md font-marlinsoft">
