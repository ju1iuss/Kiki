...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    'hero.cta': 'Currently Unavailable',
    ...
    'pricing.cta': 'Currently Unavailable',
    ...
    'apply.title': 'Service is currently unavailable',
    ...
    'apply.capacity.title': 'Service Unavailable',
    'apply.capacity.count': '',
    'apply.capacity.message': 'We are currently not accepting new applications. Please check back later.',
  ...
  de: {
    ...
    'hero.cta': 'Derzeit nicht verfügbar',
    ...
    'pricing.cta': 'Derzeit nicht verfügbar',
    ...
    'apply.title': 'Service ist derzeit nicht verfügbar',
    ...
    'apply.capacity.title': 'Service nicht verfügbar',
    'apply.capacity.count': '',
    'apply.capacity.message': 'Wir akzeptieren derzeit keine neuen Bewerbungen. Bitte schauen Sie später erneut vorbei.',
